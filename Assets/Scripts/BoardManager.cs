...
namespace Dots
{
    ...
    public class BoardManager : Singleton<BoardManager>
    {
        ...
        [SerializeField]  Board _boardToBeUsed;
        [SerializeField]  BoardCell _boardCell;
        [SerializeField]  Transform _boardInScene;

        public BoardCell[,] BoardPositions { get;  set; }
        ...
        /// <param name="j">The column number.</param>
         void CreateBoardPosition(int i, int j)
        {
        ...
        /// <param name="column">The column.</param>
         void FillEmptyCell(int row, int column)
        {
            if (row != 0)
            {
        ...
        #region Event Callbacks
         ...
         void MoveManager_OnSquareSelected(object sender, EventArgs eventArgs)
        {
