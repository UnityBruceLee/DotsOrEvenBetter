...
namespace Dots
{
    ...
    public class MoveManager : Singleton<MoveManager>
    {
        ...
        public Color StartedColor { get;  set; }
        ...
        public event EventHandler MoveEnded;
         ...
         public List<Dot> _selectedDots = new List<Dot>();
         bool _isSquareAnnounced;
         int _lastSelectedDotNumber;
         int _dotsRemoved;
        ...
        #region Event Callbacks
         ...
         void Dot_OnSelected(object sender, DotEventArgs dotEventArgs)
        {
            if (!HasMoveStarted)
            {
         ...
         void Dot_OnDeselected(object sender, DotEventArgs dotEventArgs)
        {
            if (!HasMoveStarted)
            {
                return;
         ...
         void Dot_OnEntered(object sender, DotEventArgs dotEventArgs)
        {
            if (!HasMoveStarted)
            {
                return;
        ...
        /// </summary>
         void AddSameColoredDotsToSelected()
        {
        ...
        /// <param name="dotObject">The dot object.</param>
         IEnumerator WaitForDisappear(GameObject dotObject)
        {
        ...
        /// </returns>
         bool IsDeselecting(Dot currentDot)
        {
